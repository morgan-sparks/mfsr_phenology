...
#interaction with quadratic temp_90
int_model2 <- lm(
  yday ~
    year +
    flow_90 +
...
AIC(full_model, int_model,int_model2, intercept_model)
```
...
stream_means <- estimate_means(int_model2, by = "stream")
stream_means

year_means <- estimate_means(int_model2, by = "year")
year_means
```
...
vizdata$Predicted <- insight::get_predicted(int_model2, vizdata)
