...
```{r plot-temp-regime, fig.width=8, fig.height=7, fig.pos="H", fig.cap="Modeled thermal regimes (2001-2005) for MFSR tributaries."}
...
```{r isaak-siegel, fig.width=5, fig.height=5, fig.cap="Comparison of modeled stream temperatures (Siegel et al. 2023) against empirical logger data for the Middle Fork Salmon River."}
...
isaak_siegel |> 
  ...
  theme_bw()  +
  annotate("text", x = 0, y = 20, label = paste0("r = ", round(cor(isaak_siegel$DailyMean, isaak_siegel$Stream_Temp), 2)), size = 6)
```
