...
```{r elev-lm, echo=TRUE}
m.ele.1 <- lmer(yday ~ (1|COMID), data = model_data, REML = FALSE)
m.ele.2 <- lmer(yday ~ mean_elevation + (1|COMID), data = model_data, REML = FALSE)
m.ele.3 <- lmer(yday ~ mean_elevation + stream + (1|COMID), data = model_data, REML = FALSE)
m.ele.4 <- lmer(yday ~ mean_elevation + year + (1|COMID), data = model_data, REML = FALSE)
m.ele.5 <- lmer(yday ~ mean_elevation + stream + year + (1|COMID), data = model_data, REML = FALSE)
m.ele.6 <- lmer(yday ~ mean_elevation * stream + (1|COMID), data = model_data, REML = FALSE)
m.ele.7 <- lmer(yday ~ mean_elevation * year + (1|COMID), data = model_data, REML = FALSE)
```
