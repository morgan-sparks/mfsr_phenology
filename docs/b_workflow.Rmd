...
m_elev3 <- lm(yday ~ mean_elevation * stream, data = model_data)
m_elev4 <- lmer(yday ~ mean_elevation * stream + (1|COMID), data = model_data)
compare_aic(m_elev1, m_elev2, m_elev3, m_elev4)
...
tab_model(m_elev1, m_elev2, m_elev3, m_elev4)
plot_model(m_elev4, type = "int", 
           # terms = c("mean_elevation"), 
           show.data = TRUE) 
check_model(m_elev4)
```
